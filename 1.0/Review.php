...
class Review extends App42Response {
    ...
    public function getStringView() {
        return "UserId :" . $this->userId . " : ItemId : " . $this->itemId . " : Status : " . $this->status . " : ReviewId : " . $this->reviewId . " : Comment : " . $this->comment . " : Rating : " . $this->rating . " : CreatedOn : " . $this->createdOn;
    }
