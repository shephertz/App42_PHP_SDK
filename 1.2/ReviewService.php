...
class ReviewService {
    ...
    function getCommentsByItem($itemId) {
        ...
        try {
            ...
            $contentType = $this->content_type;
            $accept = $this->accept;
            $this->url = $this->url . "/comment/item/" . $encodedItemId;
            $response = RestClient::get($this->url, $params, null, null, $contentType, $accept);
            $reviewResponseObj = new ReviewResponseBuilder();
            $reviewObj = $reviewResponseObj->buildArrayResponse($response->getResponse());
        } catch (App42Exception $e) {
    ...
    function deleteCommentByCommentId($commentId) {
        ...
        try {
            ...
            $contentType = $this->content_type;
            $accept = $this->accept;
            $this->url = $this->url . "/deleteComment/" . $encodedCommentId;
            $response = RestClient::delete($this->url, $params, null, null, $contentType, $accept);
            $reviewResponseObj = new ReviewResponseBuilder();
            $reviewObj = $reviewResponseObj->buildResponse($response->getResponse());
            $responseObj->setStrResponse($reviewObj);
