...
class ServiceAPI {
  ...
  public function buildAchievementService() {
        $achievementService = new AchievementService($this->apiKey, $this->secretKey, $this->url);
        return $achievementService;
    }
     public function buildABTestService() {
        $abTestService = new ABTestService($this->apiKey, $this->secretKey, $this->url);
        return $abTestService;
    }
   public function buildBuddyService() {
        $buddyService = new BuddyService($this->apiKey, $this->secretKey, $this->url);
        return $buddyService;
    }
      public function buildAvatarService() {
        $avatarService = new AvatarService($this->apiKey, $this->secretKey, $this->url);
